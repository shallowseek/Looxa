...
import CameraPermissionPopup from "./components/CameraScreen/cameraPop-up"
                ...
                >
                  <IconButton
                    ...
                    onPress={() => {
                      ...
                      setShowPopup(true)
                      //one home screen we first have to check whether user has given permission for camera and 
                      //if not then we will show her pop up for permission//
                      //1.
                      
                      // router.push('/CameraScreen'); // Navigate to camera screen
                    }}
                  />
